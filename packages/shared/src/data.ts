import { Country, AidItem } from './types';
...
export const aidItems: AidItem[] = [
  {
    id: 'price_1PzQaL2eZvKYlo2C0ABCDE',
    name: 'Emergency Food Pack',
    category: 'Food',
    description: 'Nutritious, ready-to-eat meals providing essential calories and vitamins for families in need.',
    price: 25.00,
    image: 'https://images.pexels.com/photos/6646917/pexels-photo-6646917.jpeg?auto=compress&cs=tinysrgb&w=600',
    priceId: 'price_1PzQaL2eZvKYlo2C0ABCDE',
  },
  {
    id: 'price_1PzQaL2eZvKYlo2C1FGHI',
    name: 'Hot Coffee Kit',
    category: 'Coffee',
    description: 'Premium coffee supplies with thermal containers, perfect for warming up communities in cold regions.',
    price: 15.00,
    image: 'https://images.pexels.com/photos/302899/pexels-photo-302899.jpeg?auto=compress&cs=tinysrgb&w=600',
    priceId: 'price_1PzQaL2eZvKYlo2C1FGHI',
  },
  {
    id: 'price_1PzQaL2eZvKYlo2C2JKLM',
    name: 'Winter Fleece Blanket',
    category: 'Clothes',
    description: 'Heavy-duty thermal fleece blanket designed for extreme cold protection in evacuation shelters.',
    price: 35.00,
    image: 'https://images.pexels.com/photos/6646917/pexels-photo-6646917.jpeg?auto=compress&cs=tinysrgb&w=600',
    priceId: 'price_1PzQaL2eZvKYlo2C2JKLM',
  },
  {
    id: 'price_1PzQaL2eZvKYlo2C3NOPQ',
    name: 'Family Meal Bundle',
    category: 'Food',
    description: "A week's supply of nutritious, shelf-stable meals for a family of four.",
    price: 75.00,
    image: 'https://images.pexels.com/photos/6591154/pexels-photo-6591154.jpeg?auto=compress&cs=tinysrgb&w=600',
    priceId: 'price_1PzQaL2eZvKYlo2C3NOPQ',
  },
  {
    id: 'price_1PzQaL2eZvKYlo2C4RSTU',
    name: 'Warm Soup Station',
    category: 'Food',
    description: 'Commercial-grade soup preparation kit to serve 50+ people with hot, nutritious meals.',
    price: 120.00,
    image: 'https://images.pexels.com/photos/539451/pexels-photo-539451.jpeg?auto=compress&cs=tinysrgb&w=600',
    priceId: 'price_1PzQaL2eZvKYlo2C4RSTU',
  },
  {
    id: 'price_1PzQaL2eZvKYlo2C5VWXY',
    name: 'Thermal Jacket',
    category: 'Clothes',
    description: 'Insulated winter jacket providing protection against freezing temperatures.',
    price: 45.00,
    image: 'https://images.pexels.com/photos/6646853/pexels-photo-6646853.jpeg?auto=compress&cs=tinysrgb&w=600',
    priceId: 'price_1PzQaL2eZvKYlo2C5VWXY',
  },
  {
    id: 'price_1PzQaL2eZvKYlo2C6YZAB',
    name: 'Coffee for 100',
    category: 'Coffee',
    description: 'Bulk coffee supply package to serve 100 hot beverages to those in need.',
    price: 50.00,
    image: 'https://images.pexels.com/photos/312418/pexels-photo-312418.jpeg?auto=compress&cs=tinysrgb&w=600',
    priceId: 'price_1PzQaL2eZvKYlo2C6YZAB',
  },
  {
    id: 'price_1PzQaL2eZvKYlo2C7CDEF',
    name: "Children's Care Pack",
    category: 'Food',
    description: 'Specially formulated nutrition pack for children with vitamins and essential nutrients.',
    price: 30.00,
    image: 'https://images.pexels.com/photos/3184183/pexels-photo-3184183.jpeg?auto=compress&cs=tinysrgb&w=600',
    priceId: 'price_1PzQaL2eZvKYlo2C7CDEF',
  },
];
